...
type Flashcard = {word :: String, sentence :: {text :: String, translation :: String, audioUrl :: String, id :: String, hoursPassed :: Number}, imageUrl :: Array String, a :: Number, b :: Number, t :: Number, startOffset :: Int}
