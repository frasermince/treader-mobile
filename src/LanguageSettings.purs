...
slide buttonText onPress textComponent = do
  ...
  M.view {style: M.css {flex: 1, alignItems: "center"}} do
      button { mode: "contained", style: endButtonStyle, onPress: RNE.capture_ $ onPress } $ M.string buttonText
  ...
  pure $ M.getJsx $ M.view {style: surfaceStyle} do
    swiper {style: M.css {height: "100%"}, horizontal: true, showButtons: true, loop: false, ref: ref} do
      M.view {style: slideStyle} do
          ...
          M.view {style: M.css {flex: 1, alignItems: "center", flexDirection: "row", alignContent: "space-between", marginBottom: 20, marginTop: 40}} do
            button { mode: "outlined", style: endButtonStyle, onPress: RNE.capture_ $ runEffectFn2 props.navigation.navigate "Settings" {}} $ M.string "Cancel"
            button { disabled: isNothing nativeLanguageSelection, mode: "contained", style: endButtonStyle, onPress: RNE.capture_ $ next ref } $ M.string "Next"


      M.view {style: slideStyle} do
          M.view {style: M.css {flex: 9}} do
            M.view {style: M.css {alignItems: "center", height: "100%", marginTop: 45}} do
              M.view {style: M.css {flex: 2, alignItems: "center", height: "100%"}} do
          ...
          M.view {style: M.css {flex: 1, alignItems: "center", flexDirection: "row", alignContent: "space-between", marginBottom: 20, marginTop: 30}} do
            ...
            button { disabled: isNothing languageSelection, mode: "contained", style: endButtonStyle, onPress: RNE.capture_ $ next ref } $ M.string "Next"
      ...
      M.view {style: slideStyle} do
          ...
          M.view {style: M.css {flex: 1, alignItems: "center", flexDirection: "row", alignContent: "space-between", marginBottom: 20, marginTop: 30}} do
            button { style: endButtonStyle, mode: "outlined", onPress: RNE.capture_ $ previous ref } $ M.string "Back"
            button { disabled: isNothing goalSelection, mode: "contained", style: endButtonStyle, onPress: RNE.capture_ $ next ref } $ M.string "Next"
